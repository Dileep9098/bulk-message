...
// export default function WhatAppMessage() {
//   return (
//     <div>
...
export default function WhatAppMessage() {
    ...
    const handleSendWhatsAppMessage = async () => {
        ...
        try {
            const response = await axiosInstance.post(Config.END_POINT_LIST["SEND_WHATSAPP_MESSAGE"],{numbers,message},{ withCredentials: true })
            ...
            if (response.data.success) {
                ...
                setMessage("");
                setSelectedUsers([]);
                document.querySelector("#bulkWhatsAppModal .btn-close").click(); // Close modal
            } else {
                showErrorMsg(response.data.message);
            }
        } catch (error) {
